...
function redirectToPreview(
  ...
  Location: '/' | `/blog/post/${string}` | `/portfolio/${string}`
): void {
...
export default async function preview(
  ...
  if (post) {
    redirectToPreview(res, previewData, `/blog/post/${post.slug}`);
  } else {
    redirectToPreview(res, previewData, `/portfolio/${project.slug}`);
  }
}
