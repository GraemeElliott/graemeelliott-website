export default function AboutMe() {
  return (
    <section className="about-me-container homepage-section">
      <h1 className="about-me-header homepage-header">About Me</h1>
      <div className="about-me-text-container">
        <div className="about-me-left">
          <p>
            I am an accomplished Product Manager and Subject Matter Expert in
            Brand Protection with more than ten years of success in helping
            companies define and design value-driven solutions that assist in
            achieving overall strategic business growth. I have strong
            analytical and communication skills coupled with the ability to
            multi-task, work independently, and thrive in a fast-paced, start-up
            environment.
          </p>
          <p>
            Over the years I have been developing and implementing successful
            global brand protection programs for clients to help protect their
            brands’ value. I have also shown my ability to develop deep and
            enduring relationships with clients, where I have maintained
            existing services as well as seek new opportunities for expansion.
          </p>
          <p>
          ...
          <p>
            ...
            gathering, analysis and visualisation. This includes using
            technologies such as SQL for database queries as well as Power BI
            and Tableau for data cleaning and visualisation.
          </p>
        </div>
        <div className="about-me-right">
          <p>
            This has enabled me to produce dashboards and reports that have been
            used to give further insights into trends, map out any problems
            needing to be sold, and make decision making easier for my team and
            my clients. Data analysis, as well as presenting my findings, is at
            the forefront of every task that I do.
          </p>
          <p>
          ...
          <p>
            As a QA Engineer, I have experience in regression testing and
